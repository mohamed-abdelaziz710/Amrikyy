...
function initChatbot() {
  ...
  chatbotBubble.innerHTML = `
    ...
    <div class="chatbot-tooltip" data-translate="chatbotTooltip">Chat with Amrikyy AI</div>
  `;
  ...
  chatbotContainer.innerHTML = `
    <div class="chatbot-header">
      <div class="chatbot-title">
        ...
        <span data-translate="chatbotTitle">Amrikyy AI Assistant</span>
      </div>
    ...
    <div class="chatbot-messages">
      <div class="message bot-message">
        <div class="message-content">
          <p data-translate="chatbotWelcome">👋 Hello! I'm your Amrikyy AI assistant. How can I help you today?</p>
        </div>
        <div class="message-time">Just now</div>
      </div>
    </div>
    <div class="chatbot-input">
      <input type="text" data-translate-placeholder="chatbotInputPlaceholder" placeholder="Type your message..." id="chatbotInput">
